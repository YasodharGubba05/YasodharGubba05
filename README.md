...
### `Full-Stack Engineer` · `AI/ML Systems` · `SRM University AP '27`
...
focus:
  - End-to-end product development (UI → API → DB → ML)
...
**Stack:** TypeScript · React · Redis pub/sub · WebSockets · Node.js

- End-to-end: interactive React UI + real-time backend
- Live multi-user collaboration with Redis pub/sub
- Presence awareness, shared sessions, productivity tooling
- Sub-100ms message delivery architecture
...
**Stack:** Python · XGBoost · FastAPI · scikit-learn · JavaScript

- Dashboard UI for sprint health visualization
- ML-powered sprint risk forecasting with XGBoost
- Burnout signal detection using team velocity patterns
...
│                                                         │
│  ▸ Built NLP pipelines (TF-IDF + ML classifiers)        │
│    for fake-news detection at scale                     │
│  ▸ Overhauled text preprocessing → higher accuracy      │
└─────────────────────────────────────────────────────────┘
...
│                                                         │
│  ▸ Built & shipped full-stack responsive web apps       │
│    using HTML, CSS, JavaScript                          │
│  ▸ Maintained clean Git workflows for team delivery     │
└─────────────────────────────────────────────────────────┘
```
